...
import PanelList from './pages/engineering/panelization/PanelizationDashboard.jsx'
import PanelCreate from './pages/engineering/panelization/PanelCreate.jsx'
import PanelDetails from './pages/engineering/panelization/PanelJobDetails.jsx'
import PanelTemplates from './pages/engineering/panelization/PanelTemplateLibrary.jsx'
    ...
    <>
      <Routes>
        ...
        >
          ...
          {/* Logistics Routes */}
          <Route path="logistics/dispatch" element={<DispatchQueue />} />
          <Route path="logistics/dispatch/create" element={<DispatchCreate />} />
          <Route path="logistics/dispatch/queue" element={<DispatchQueue />} />
          <Route path="logistics/dispatch/:dispatchId" element={<DispatchDetails />} />
          <Route path="logistics/dispatch/:dispatchId/checklist" element={<DispatchChecklist />} />
          <Route path="logistics/dispatch/details" element={<Navigate to="/dashboard/logistics/dispatch" replace />} />
