...
public class AuditLogService {
    ...
    public List<AuditLogDto> list(String query, String module, String action, AuditLog.Severity severity, 
        ...
        Page<AuditLog> auditLogs = auditLogRepository.findByCriteriaWithPagination(
            fromTime, toTime, actor != null ? Long.parseLong(actor) : null, module, action, entity, severity, null, query, pageable);
    ...
    public AuditLogDto create(AuditLogPayload payload) {
        ...
        // ID is auto-generated by the database, so we don't set it manually
    ...
    private void applyPayload(AuditLog target, AuditLogPayload payload) {
        ...
        target.setUserId(payload.actor() != null ? Long.parseLong(payload.actor()) : null);
    ...
    private AuditLogDto toDto(AuditLog auditLog) {
        return new AuditLogDto(
            ...
            auditLog.getUserId() != null ? auditLog.getUserId().toString() : "",
