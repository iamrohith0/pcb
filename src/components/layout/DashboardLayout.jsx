  ...
  const nav = useMemo(() => {
    ...
    const quality = {
      ...
      items: [
        ...
        { to: "/dashboard/quality/ncr", label: "NCR / CAPA", icon: BadgeAlert },
        { to: "/dashboard/quality/coa", label: "COA / Certificates", icon: BadgeCheck },
        { to: "/dashboard/quality/aoi", label: "AOI", icon: Eye },
        { to: "/dashboard/quality/etest", label: "E-Test", icon: Zap },
      ],
    };
